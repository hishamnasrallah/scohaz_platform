...
class Build(models.Model):
    """Simplified build request model"""
    ...
    # Relationships
    project = models.ForeignKey(FlutterProject, on_delete=models.CASCADE, related_name='simple_builds')
    ...
    apk_size = models.BigIntegerField(null=True, blank=True)
