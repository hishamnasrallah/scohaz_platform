...
class BuildAdmin(admin.ModelAdmin):
    list_display = [
        'id', 'project', 'status_badge', 'build_type', 'version_number',
    ...
    readonly_fields = [
        'project', 'status', 'apk_file', 'apk_size', 'flutter_version',
    ...
    def download_button(self, obj):
        """Add a download button for successful builds"""
    ...
    def has_add_permission(self, request):
        # Builds should only be created through the API
        return False
...
class BuildLogAdmin(admin.ModelAdmin):
    ...
    def has_add_permission(self, request):
        # Logs should only be created by the build process
        return False
